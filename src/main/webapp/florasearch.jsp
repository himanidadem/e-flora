...
$.get("navigation.html", function(data){
            ...
            <div class="row">
              ...
              <ul class="px-0">
                ...
                <% if(ch!=null)
                {
                	...
                	<input class="form-control silent_text" id="search_bar" type="search"
                    placeholder="Scientific/Vernacular/Common Name" aria-label="search" name="search" value="<%=ch%>">
                    <%
                }
                    else{                    
                    %>
  ...
  <section >
    <div class="container mt-5">
      <div class="row g-2 ">
     		 <%	
					List<trees> post = obj.getdatabysearch(ch);
					for (trees po : post) {
          ...
          <div class="image_container" onclick="location.href='./t1.jsp?pid=<%=po.getPid()%>'" data-aos="fade">
            ...
            <div class="image_content">
              <span class="image_name"><%=po.getSname() %> 
      ...
      <%
			...
			{
			    %>
			     <section id="resultset" tabindex="1">
			     	<div class="container">
			     		<div class="noresult_alert text-center">
...
/*  window.onbeforeunload = function() 
	...
	{ window.location = './flora.jsp'; }, 0);
		window.onbeforeunload = null;  // necessary to prevent infinite loop, that kills your browser } 
		
		
		/* window.onload = function () { window.location = "./flora.jsp"; } */
		
 /*  function confirmExit() { alert("exiting"); window.location.href='./flora.jsp'; return true; } window.onload = confirmExit();   */


/* submitFormOkay = false; $(document.body).on("click", "a", function() { submitFormOkay = true; }); window.onbeforeunload = function(event) { event.preventDefault(); if (!submitFormOkay) { window.setTimeout(function () { window.location = "./flora.jsp"; }, 0); window.onbeforeunload = null; } }
 */</script>
</html>