                ...
                <ul class="px-0">
                  ...
                  %>                 
                    <select class="form-select attribute_font drop_down m-1" name="part">
                      <option selected hidden="true"><%=part%></option>
                       <%	
                  ...
                  %>
                    <select class="form-select attribute_font drop_down m-1" name="ccat">
                      <option selected hidden="true"><%=ccat%></option>
                      <%	
                ...
                <ul class="px-0">
                  ...
                  %>
                    <select class="form-select attribute_font drop_down m-1" name="location">
                      <option selected hidden="true"><%=location%></option>
                  ...
                  %>
                    <select class="form-select attribute_font drop_down m-1" name="rtype">
                      <option selected hidden="true"><%=rtype%></option>
                       <%	
    ...
    <div class="container mt-5">
      <div class="row g-2 ">
     		 <%	
				...
				if(rtype.equals("Root System")) 
					rtype="";
				if(part.equals("Useful Part")) 
					part="";
				if(location.equals("Campus Location")) 
					location="";
				if(ccat.equals("Category")) 
					ccat="";
				
					List<trees> post = obj.getdatabyfilter(rtype,part,location,ccat);
					for (trees po : post) {
